...
{
    /// <summary>
    /// Represents a sample that loads a Model from a file-picker, and uses a custom Material Mapper to create Autodesk Interactive materials, when suitable.
    /// </summary>
    public class AutodeskInteractiveMaterialsSample : MonoBehaviour
    {
        ...
        public void LoadModel()
        {
            ...
            // Adds the appropriate Autodesk Interactive Material Mapper based on the selected default Material Mapper.
